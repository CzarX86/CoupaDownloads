# Proposta de Mudança: Inicialização do Contract Downloader (App Independente e Portátil)

## 1. Identificação
- **Número da Proposta**: 17
- **Título**: Criação do Contract Downloader (Aplicação Standalone, Portátil e Ultra-Resiliente)
...
### In Scope
- Criação do diretório `/ContractDownloader`.
