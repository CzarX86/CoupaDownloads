# Arquitetura 21 — Model Management UI, Side‑by‑Side Preference Review, and Docs note (model switching)

- Status: draft
- Data: 2025-09-23
- Responsáveis: TBD
- Observações: Baseado no plano `21-model-management-and-preference-ui-PR.md`.
