# Arquitetura 18 — Advanced Extractor Upgrades: ST fine-tune, reranker, multi-doc aggregation, and HITL training loop

- Status: draft
- Data: 2025-09-23
- Responsáveis: TBD
- Observações: Baseado no plano `18-advanced-extractor-upgrades-PR.md`.
