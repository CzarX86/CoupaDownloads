...
class ResultAggregator:
    ...
    def __init__(
        ...
        """
        self.csv_handler: Optional[CSVHandler] = csv_handler
        self.sqlite_handler: Optional[SQLiteHandler] = sqlite_handler
        self.telemetry: Optional[TelemetryProvider] = telemetry
    ...
    def finalize(self) -> None:
        ...
        if self.csv_handler:
            try:
                self.csv_handler.shutdown_csv_handler()  # type: ignore[attr-defined]
            except Exception as e:
