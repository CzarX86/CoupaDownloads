...
Este documento registra a arquitetura desejada para revisão futura. A execução atual do ContractDownloader continuará funcionando com input manual, exigindo `PO_NUMBER` e `SUPPLIER`.
